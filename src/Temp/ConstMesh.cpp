...
ConstMesh::ConstMesh(std::shared_ptr<nMaterial> initialMaterial, const std::vector<Vertex>& vertices, std::vector<Point2<float>> uv,
...
const std::shared_ptr<nMaterial>& ConstMesh::getInitialMaterialPtr() const {
