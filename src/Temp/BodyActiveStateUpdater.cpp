...
BodyActiveStateUpdater::BodyActiveStateUpdater(const BodyContainer& bodyContainer) :
	...
	squaredLinearSleepingThreshold(0.15 * 0.15/*
		ConfigService::instance().getFloatValue("island.linearSleepingThreshold") * ConfigService::instance().getFloatValue("island.linearSleepingThreshold")*/),
	squaredAngularSleepingThreshold(0.05 * 0.05/*
		ConfigService::instance().getFloatValue("island.angularSleepingThreshold") * ConfigService::instance().getFloatValue("island.angularSleepingThreshold")*/)
{
}
