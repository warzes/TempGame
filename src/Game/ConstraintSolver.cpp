...
ConstraintSolver::ConstraintSolver() :
	biasFactor(0.2/*ConfigService::instance().getFloatValue("constraintSolver.biasFactor")*/),
	useWarmStarting(true/*ConfigService::instance().getBoolValue("constraintSolver.useWarmStarting")*/),
	restitutionVelocityThreshold(1.0/*ConfigService::instance().getFloatValue("constraintSolver.restitutionVelocityThreshold")*/)
{
	unsigned int constraintSolvingDataPoolSize = 4096/*ConfigService::instance().getUnsignedIntValue("constraintSolver.constraintSolvingPoolSize")*/;
