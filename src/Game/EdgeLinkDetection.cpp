...
EdgeLinkDetection::EdgeLinkDetection(float jumpMaxLength) :
	...
	edgeLinkMinLength(0.05/*ConfigService::instance().getFloatValue("navMesh.edgeLinkMinLength")*/),
	equalityDistanceThreshold(0.03/*ConfigService::instance().getFloatValue("navMesh.edgeLinkEqualityDistanceThreshold")*/) {
