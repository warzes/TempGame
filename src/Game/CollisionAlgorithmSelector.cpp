...
#include "ConvexConvexCollisionAlgorithm.h"
#include "CompoundAnyCollisionAlgorithm.h"
...
void CollisionAlgorithmSelector::initializeAlgorithmPool() {
	...
	unsigned int algorithmPoolSize = 4096/*ConfigService::instance().getUnsignedIntValue("narrowPhase.algorithmPoolSize")*/;
