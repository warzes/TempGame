...
PhysicsTransform::PhysicsTransform(const nTransform<float>& transform) :
...
*/
nTransform<float> PhysicsTransform::toTransform() const {
	return nTransform<float>(position, orientation);
}
